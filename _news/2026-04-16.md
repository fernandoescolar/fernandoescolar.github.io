...
- [OpenAI lanza GPT‑5.4‑Cyber especializado en ciberdefensa](#openai-lanza-gpt-54-cyber-especializado-en-ciberdefensa)
...
- [Actualización de la política de soporte de .NET y ASP.NET](#actualizacion-de-la-politica-de-soporte-de-net-y-aspnet)
- [Actualización acumulativa de .NET Framework para Azure Stack HCI (KB5082418)](#actualizacion-acumulativa-de-net-framework-para-azure-stack-hci-kb5082418)
- [CNCF amplía el programa Kubernetes AI Conformance y añade validación para agentes](#cncf-amplia-el-programa-kubernetes-ai-conformance-y-anade-validacion-para-agentes)
- [Google Developers: recomendaciones para construir agentes tras el “Agent Bake‑Off”](#google-developers-recomendaciones-para-construir-agentes-tras-el-agent-bake-off)
