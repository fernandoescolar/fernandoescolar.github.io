...
- [GLM-5.1 (Z.ai): modelo open‑source focalizado en coding y tareas largas](#glm-51-zai-modelo-open-source-focalizado-en-coding-y-tareas-largas)
- [Oleada de lanzamientos open‑source y frameworks de agentes (Gemma 4, Llama 4, Mistral, Goose)](#oleada-de-lanzamientos-open-source-y-frameworks-de-agentes-gemma-4-llama-4-mistral-goose)
- [Anthropic confirma «Claude Mythos» y limita acceso vía Project Glasswing](#anthropic-confirma-claude-mythos-y-limita-acceso-via-project-glasswing)
- [Anthropic: interrupciones y outages de Claude durante la semana (abril 6–8)](#anthropic-interrupciones-y-outages-de-claude-durante-la-semana-abril-6-8)
