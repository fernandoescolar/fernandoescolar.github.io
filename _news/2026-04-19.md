...
- [Kubernetes 1.36 programado: qué traerá y calendario cercano](#kubernetes-136-programado-qu%C3%A9-traer%C3%A1-y-calendario-cercano)
- [Roon cambia requisitos mínimos: impacto en NAS y homelabs](#roon-cambia-requisitos-m%C3%ADnimos-impacto-en-nas-y-homelabs)
- [Actividad en foros de desarrolladores NVIDIA: drivers y Linux (últimas 48h)](#actividad-en-foros-de-desarrolladores-nvidia-drivers-y-linux-%C3%BAltimas-48h)
