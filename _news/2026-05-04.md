...
- [Anthropic cerca de un joint venture de 1.5B con firmas de Wall Street](#anthropic-cerca-de-un-joint-venture-de-15b-con-firmas-de-wall-street)
- [Google y la transición de Vertex AI al Gemini Enterprise Agent Platform](#google-y-la-transición-de-vertex-ai-al-gemini-enterprise-agent-platform)
- [Guía práctica: sandboxes de ejecución para agentes AI](#guía-práctica-sandboxes-de-ejecución-para-agentes-ai)
- [CVE-2026-31431 (CopyFail): añadido al catálogo KEV de CISA](#cve-2026-31431-copyfail-añadido-al-catálogo-kev-de-cisa)
- [Nvidia adelanta EOL de varios módulos Jetson por falta de memoria](#nvidia-adelanta-eol-de-varios-módulos-jetson-por-falta-de-memoria)
- [DC‑RAG: un marco dual‑canal para Retrieval‑Augmented Generation (RAG)](#dcrag-un-marco-dualcanal-para-retrievalaugmented-generation-rag)
- [Admina (v0.9.0): framework open‑source para gobernanza de IA](#admina-v090-framework-opensource-para-gobernanza-de-ia)
- [Nueva entrada en la base de datos de vulnerabilidades de Go (GO‑2026‑4462)](#nueva-entrada-en-la-base-de-datos-de-vulnerabilidades-de-go-go20264462)
- [Resumen de lanzamientos y movimientos en modelos LLM (inicio de mayo 2026)](#resumen-de-lanzamientos-y-movimientos-en-modelos-llm-inicio-de-mayo-2026)
- [cPanel: CVE crítico añadido a KEV y riesgo para hosting compartido](#cpanel-cve-crítico-añadido-a-kev-y-riesgo-para-hosting-compartido)
