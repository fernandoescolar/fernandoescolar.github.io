...
- [Microsoft publica Agent Governance Toolkit (open‑source)](#microsoft-publica-agent-governance-toolkit-opensource)
- [InfluxDB: el tag `latest` de Docker apuntará a InfluxDB 3 Core](#influxdb-el-tag-latest-de-docker-apuntará-a-influxdb-3-core)
- [Resumen semanal de amenazas agenticas (Intel) — abril 7, 2026](#resumen-semanal-de-amenazas-agenticas-intel-abril-7-2026)
...
- [Unit 42 (Palo Alto) describió el fallo en Gemini Live para Chrome (CVE‑2026‑0628)](#unit-42-palo-alto-describió-el-fallo-en-gemini-live-para-chrome-cve20260628)
