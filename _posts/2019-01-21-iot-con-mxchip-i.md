...
![Troy McClure y Jimmy]({{site.baseurl}}/public/2019/01/iot-mcclure-start.png)
...
![configure wifi]({{site.baseurl}}/public/2019/01/iot-mxchip-wifi1.png)
...
![configure wifi]({{site.baseurl}}/public/2019/01/iot-mxchip-wifi3.png)
...
![configure wifi]({{site.baseurl}}/public/2019/01/iot-mxchip-wifi2.png)
...
![copy the file in the mxchip folder]({{site.baseurl}}/public/2019/01/iot-copy-firmware.png)

Automáticamente el dispositivo se actualizará usando ese archivo y se reiniciará.

![Troy McClure approves]({{site.baseurl}}/public/2019/01/iot-mcclure-middle.png)
...
![install arduino IDE for windows]({{site.baseurl}}/public/2019/01/iot-arduino-ide.png)

Después en vscode, en las extensiones buscaremos una llamada "Arduino", desarrollada por Microsoft, y la instalaremos:

![install arduino vscode extension]({{site.baseurl}}/public/2019/01/iot-vscode-arduino.png)
...
![edit vscode settings.json]({{site.baseurl}}/public/2019/01/iot-vscode-settings.png)
...
![install azure iot tools vscode extension]({{site.baseurl}}/public/2019/01/iot-vscode-tools.png)
...
![vscode examples for IoT]({{site.baseurl}}/public/2019/01/iot-vscode-workbench.png)
...
![Troy McClure & Jimmy]({{site.baseurl}}/public/2019/01/iot-mcclure-end.png)