...
<div style="background-color: #e5b909">
Este documento corresponde con el guión realizado para dar la charla de "Por qué todo lo que subo a azure está mal" para la Global Azure Bootcamp de 2018. Si lo prefieres, puedes ver el vídeo de la charla en [este enlace](https://www.youtube.com/watch?v=cMwHQlmGnr0 "Canal de YouTube de GAB 2018").
</div>
...
![una pequeña historia]({{site.baseurl}}/_drafts/Slide03.png)
...
![el camino a la nube]({{site.baseurl}}/_drafts/Slide04.png)
...
![empieza los problemas]({{site.baseurl}}/_drafts/Slide05.png)
...
![recomendaciones generales]({{site.baseurl}}/_drafts/Slide07.png)
...
![Recomendaciones para Azure Active Directory]({{site.baseurl}}/_drafts/Slide09.png)
...
![Recomendaciones para redis]({{site.baseurl}}/_drafts/Slide11.png)
...
![Recomendaciones Azure Cosmos Db]({{site.baseurl}}/_drafts/Slide13.png)
...
![Recomendaciones Azure Sql Database]({{site.baseurl}}/_drafts/Slide15.png)
...
![Recomendaciones App Services con nodejs]({{site.baseurl}}/_drafts/Slide17.png)
...
![Recomendaciones para App Services con PHP]({{site.baseurl}}/_drafts/Slide19.png)
...
![Recomendaciones para App Services con Java]({{site.baseurl}}/_drafts/Slide21.png)
...
![Sobre el precio de Azure]({{site.baseurl}}/_drafts/Slide23.png)
...
![Me voy a amazon]({{site.baseurl}}/_drafts/Slide25.png)
