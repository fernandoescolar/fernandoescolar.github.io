...
![raspi-config](/assets/uploads/2023/02/raspi_config_menu.webp)

Y seleccionamos la opción `SSH`:

![raspi-config](/assets/uploads/2023/02/raspi_config_ssh.webp)
...
![Pi Hole Dashboard](/assets/uploads/2023/02/pihole-dashboard.webp)
