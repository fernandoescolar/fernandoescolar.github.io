...
Después de una serie de comentarios que me han llegado vía twitter, me veo en la obligación de realizar una acualización al artículo:

### Fe de errores

En la sección de 2007 se menciona la creación de la _Task Parallel Library_ (TPL) y de las _Reactive Extensions_ (Rx). Si bien es verdad que existen implementaciones de ambas para la versión del _Framework_ 3.5, no fue hasta 2010 y 2011 respectivamente, cuando estuvieron disponibles públicamente. Apareciendo TPL para versión del _Framework_ 4.0 y Rx para 3.5 y 4.0 originariamente. Dentro de las Rx para la versión del framework 3.5 existe un _backport_ de TPL.
...
¡Muchas gwordracias [Adri](https://twitter.com/mancku)!
...
Y otro buen aporte excelente por parte de [Pablo Álvarez Doval](https://twitter.com/PabloDoval) trata sobre cómo Microsoft implementó .Net a partir de una plataforma desarrollada por Colusa Software Inc. Empresa que fundada en 1994 y adquirida en 1996, que desarrollaba por aquel entonces una plataforma llamada Omniware cuyo fin era ejecutar código en C/C++ en una máquina virtual multiplataforma llamada OmniVM.
