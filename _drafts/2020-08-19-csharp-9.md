...
> Como cada año, tan solo queda añadir que algunas de estas funcionalidades no llegarán a aparecer. Y que otras podrían llegar a publicarse, pero de una forma diferente a la que aquí exponemos.
...
public record Place
{
    ...
    public Product(string name, string founder)
...
Pues esto se acabó. Ahora podemos ponernos a escribir directamente nuestro programa de consola, como si esto fuera C de toda la vida:
...
Y por dividiendo por _la diagonal Vicky Mendoza_:
...
1. Descargar e instalar [LINQPad6](https://www.linqpad.net/LINQPad6.aspx)2. Abrir la aplicación.
...
![Configuración de LINQPad6](/public/uploads/2020/08/linqpad6-roslyn-config.png)