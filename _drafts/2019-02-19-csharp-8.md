...
Podemos iterar sobre la colección (``People``) y en una sentencia ``if`` mapear y filtrar las propiedades de cada uno de los elementos. De tal forma que este código:
